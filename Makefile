...
# operating system:  Linux 4.2.0-16-generic x86_64 [ELF] (4.2.0)
# libc:	(6.21.0)
# binutils:	(225)
...
# documentation.
#
# Unisys Corporation holds worldwide patent rights on the Lempel
# Zev Welch (LZW) compression technique employed in the CompuServe
# GIF image file format as well as in other formats. Unisys has
# made it clear, however, that it does not require licensing or
# fees to be paid for freely distributed, non-commercial
# applications (such as xearth) that employ LZW/GIF
# technology. Those wishing further information about licensing
# the LZW patent should contact Unisys directly at
...
# AND FITNESS, IN 0 EVENT SHALL THE AUTHOR BE LIABLE FOR ANY
...
# THIS SOFTWARE.
        ...
        DEFINES =
           SRCS = xearth.c dither.c extarr.c gif.c gifout.c mapdata.c                   markers.c ppm.c render.c resources.c scan.c sunpos.c                   x11.c font.c png.c bmp.c jpeg.c overlay.c

           OBJS = xearth.o dither.o extarr.o gif.o gifout.o mapdata.o                   markers.o ppm.o render.o resources.o scan.o sunpos.o                   x11.o font.o png.o bmp.o jpeg.o overlay.o

        DEPLIBS = $(DEPXTOOLLIB) $(DEPXLIB)
LOCAL_LIBRARIES = $(XTOOLLIB) $(XLIB)
  SYS_LIBRARIES = -lm -lgd

#   Generate a xearth jpg and use it as background
#   >./xearth -size "2560 1600" -jpg > /tmp/x.jpg
#
...
install:: xearth
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  xearth $(DESTDIR)$(BINDIR)/xearth

all:: xearth.$(MANNEWSUFFIX)

xearth.$(MANNEWSUFFIX): xearth.$(MANSRCSUFFIX)
	$(RM) $@
	if test -z "$(PREPROCESSMANPAGES)" ; then \
	   cd `dirname xearth` && \
	   $(LN) `basename xearth.$(MANSRCSUFFIX)` `basename $@`; \
	else \
	      	     $(RAWCPP)  $(MANDEFS) $(EXTRAMANDEFS) \
	     < xearth.$(MANSRCSUFFIX) | sed -e '/^#  *[0-9][0-9]*  *.*$$/d' 			-e '/^#line  *[0-9][0-9]*  *.*$$/d' 			-e '/^[ 	]*XCOMM$$/s/XCOMM/#/' 			-e '/^[ 	]*XCOMM[^a-zA-Z0-9_]/s/XCOMM/#/' 			-e '/^[ 	]*XHASH/s/XHASH/#/' 			-e '/\@\@$$/s/\@\@$$/\\/' >$@; \
	fi

cleandir::
	$(RM) xearth.$(MANNEWSUFFIX)

install.man:: xearth.$(MANNEWSUFFIX)
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) xearth.$(MANNEWSUFFIX) $(DESTDIR)$(MANDIR)/xearth.$(MANSUFFIX)
